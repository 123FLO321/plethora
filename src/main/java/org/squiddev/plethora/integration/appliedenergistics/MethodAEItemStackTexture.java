...
public final class MethodAEItemStackTexture {
	private MethodAEItemStackTexture() {
	}
	...
	public static String getTexture(IContext<IAEItemStack> context, @Optional(defInt = 1) int scale) throws LuaException {
